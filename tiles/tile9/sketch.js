...
class Tile {
  ...
  move() {
    ...
    if (this.lineup) {
      ...
      push();
      stroke(this.c); // Salmon Pink
      strokeWeight(0.5);
      line(this.originX, height, mouseX, mouseY);
      line(this.originX, 0, mouseX, mouseY);

      line(width, this.originY, mouseX, mouseY);
      line(0, this.originY, mouseX, mouseY);
      pop();
